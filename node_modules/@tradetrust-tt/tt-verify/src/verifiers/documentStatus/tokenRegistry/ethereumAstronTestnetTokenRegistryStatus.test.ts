...
import { documentAstronValidWithToken } from "../../../../test/fixtures/v2/documentAstronTestnetValidWithToken";
import { documentMixedIssuance } from "../../../../test/fixtures/v2/documentMixedIssuance";
import { documentAstronNotIssuedTokenRegistry } from "../../../../test/fixtures/v2/documentAstronTestnetNotIssuedTokenRegistry";
...
import v3TokenRegistryIssuedRaw from "../../../../test/fixtures/v3/astronTestnetTokenRegistry-issued.json";
import v3TokenRegistryWrappedRaw from "../../../../test/fixtures/v3/astronTestnetTokenRegistry-wrapped.json";
...
const options = {
  provider: generateProvider({
    ...
    url: "https://dev-astronlayer2.bitfactory.cn/query/",
  }),
};
      ...
      expect(fragment).toMatchInlineSnapshot(`
        {
          "data": {
            "details": [
              {
                "address": "0xb1Bf514b3893357813F366282E887eE221D5C2dA",
                "minted": false,
                "reason": {
                  "code": 1,
                  "codeString": "DOCUMENT_NOT_MINTED",
