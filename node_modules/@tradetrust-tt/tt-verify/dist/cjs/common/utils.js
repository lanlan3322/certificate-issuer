...
const ethers = Object.assign({}, ethers_1.ethers);
if ((_a = ethers === null || ethers === void 0 ? void 0 : ethers.version) === null || _a === void 0 ? void 0 : _a.startsWith("6.")) {
    ethers.providers = Object.assign(Object.assign({}, ethers === null || ethers === void 0 ? void 0 : ethers.providers), { StaticJsonRpcProvider: ethers.JsonRpcProvider, InfuraProvider: ethers.InfuraProvider, AlchemyProvider: ethers.AlchemyProvider });
}
const getDefaultProvider = (options) => {
    const network = options.network || process.env.PROVIDER_NETWORK || "homestead";
    const providerType = process.env.PROVIDER_ENDPOINT_TYPE || "infura";
    const apiKey = process.env.PROVIDER_API_KEY || (providerType === "infura" && config_1.INFURA_API_KEY) || "";
    ...
    const uselessProvider = (0, exports.generateProvider)({
        providerType,
        network,
        apiKey,
    });
    const connection = Object.assign(Object.assign({}, uselessProvider.connection), { throttleLimit: 3 });
...
const getProvider = (options) => {
    var _a;
    return (_a = options.provider) !== null && _a !== void 0 ? _a : (0, exports.getDefaultProvider)(options);
};
...
const generateProvider = (options) => {
    ...
    const network = (options === null || options === void 0 ? void 0 : options.network) || process.env.PROVIDER_NETWORK || "homestead";
    const provider = (options === null || options === void 0 ? void 0 : options.providerType) || process.env.PROVIDER_ENDPOINT_TYPE || "infura";
    const url = (options === null || options === void 0 ? void 0 : options.url) || process.env.PROVIDER_ENDPOINT_URL || "";
    const apiKey = (options === null || options === void 0 ? void 0 : options.apiKey) || (provider === "infura" && process.env.INFURA_API_KEY) || process.env.PROVIDER_API_KEY || "";
        ...
        case "alchemy":
            if (apiKey) {
                return network === "sepolia"
                    ? new ethers_1.providers.JsonRpcProvider(`https://eth-sepolia.g.alchemy.com/v2/${apiKey}`, network)
                    : new ethers_1.providers.AlchemyProvider(network, apiKey);
            }
            return network === "sepolia"
                ? new ethers_1.providers.JsonRpcProvider(`https://eth-sepolia.g.alchemy.com/v2/`, network)
                : new ethers_1.providers.AlchemyProvider(network);
        case "jsonrpc":
            return new ethers_1.providers.JsonRpcProvider(url);
        default:
 ...
 * @param name
 */
const getFragmentByName = (name) => (fragments) => fragments.find((fragment) => fragment.name === name);
exports.getFragmentByName = getFragmentByName;
exports.getOpenAttestationHashFragment = (0, exports.getFragmentByName)("OpenAttestationHash");
exports.getOpenAttestationDidSignedDocumentStatusFragment = (0, exports.getFragmentByName)("OpenAttestationDidSignedDocumentStatus");
exports.getOpenAttestationEthereumDocumentStoreStatusFragment = (0, exports.getFragmentByName)("OpenAttestationEthereumDocumentStoreStatus");
exports.getOpenAttestationEthereumTokenRegistryStatusFragment = (0, exports.getFragmentByName)("OpenAttestationEthereumTokenRegistryStatus");
exports.getOpenAttestationDidIdentityProofFragment = (0, exports.getFragmentByName)("OpenAttestationDidIdentityProof");
exports.getOpenAttestationDnsDidIdentityProofFragment = (0, exports.getFragmentByName)("OpenAttestationDnsDidIdentityProof");
exports.getOpenAttestationDnsTxtIdentityProofFragment = (0, exports.getFragmentByName)("OpenAttestationDnsTxtIdentityProof");
/**
 * Simple typed utility to return fragments depending on the type
 */
const getFragmentByType = (type) => (fragments) => fragments.filter((fragment) => fragment.type === type);
...
const isDocumentStoreAddressOrTokenRegistryAddressInvalid = (fragments) => {
    var _a, _b, _c, _d;
    const documentStoreIssuedFragment = (0, exports.getOpenAttestationEthereumDocumentStoreStatusFragment)(fragments);
    const tokenRegistryMintedFragment = (0, exports.getOpenAttestationEthereumTokenRegistryStatusFragment)(fragments);
