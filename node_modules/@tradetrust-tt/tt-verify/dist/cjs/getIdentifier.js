...
const dnsDidProof_type_1 = require("./verifiers/issuerIdentity/dnsDid/dnsDidProof.type");
const openAttestationDnsTxt_type_1 = require("./verifiers/issuerIdentity/dnsTxt/openAttestationDnsTxt.type");
var IdentityProof;
...
const getDnsIdentifierProof = ({ data }) => {
    const type = "DNS";
...
const getDnsDidIdentifierProof = ({ data }) => {
    const type = "DNS-DID";
...
const getDidIdentifierProof = ({ data }) => {
    const type = "DID";
...
const getIdentityProofFragment = (fragments) => {
