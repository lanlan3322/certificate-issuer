...
const openAttestationHash_1 = require("./verifiers/documentIntegrity/hash/openAttestationHash");
...
const tokenRegistry_1 = require("./verifiers/documentStatus/tokenRegistry");
...
const documentStore_1 = require("./verifiers/documentStatus/documentStore");
...
const didSigned_1 = require("./verifiers/documentStatus/didSigned");
...
const dnsTxt_1 = require("./verifiers/issuerIdentity/dnsTxt");
...
const did_1 = require("./verifiers/issuerIdentity/did");
...
const dnsDid_1 = require("./verifiers/issuerIdentity/dnsDid");
...
Object.defineProperty(exports, "verifySignature", { enumerable: true, get: function () { return verifier_1.verifySignature; } });
...
const verify = (0, verificationBuilder_1.verificationBuilder)(openAttestationVerifiers, defaultBuilderOption);
