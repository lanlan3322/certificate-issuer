export const isValid = (verificationFragments, types = ["DOCUMENT_STATUS", "DOCUMENT_INTEGRITY", "ISSUER_IDENTITY"]) => {
    ...
    return types.every((type) => {
        ...
        return (verificationFragmentsForType.some((fragment) => fragment.status === "VALID") &&
