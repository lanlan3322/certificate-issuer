...
export declare const resolve: (didUrl: string, resolver?: Resolver) => Promise<DIDDocument | undefined>;
export declare const getVerificationMethod: (did: string, key: string, resolver?: Resolver) => Promise<VerificationMethod | undefined>;
