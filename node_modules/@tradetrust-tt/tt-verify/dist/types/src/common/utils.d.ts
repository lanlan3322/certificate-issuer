...
import { ProviderDetails, VerificationBuilderOptions, VerificationBuilderOptionsWithNetwork, VerificationFragment } from "../types/core";
 ...
 */
export declare const generateProvider: (options?: ProviderDetails) => providers.Provider;
/**
 ...
 */
type ValidFragment<Type> = Type extends {
    status: "VALID";
} ? Type : never;
type InvalidFragment<Type> = Type extends {
    status: "INVALID";
} ? Type : never;
type SkippedFragment<Type> = Type extends {
    status: "SKIPPED";
} ? Type : never;
type ErrorFragment<Type> = Type extends {
    status: "ERROR";
} ? Type : never;
