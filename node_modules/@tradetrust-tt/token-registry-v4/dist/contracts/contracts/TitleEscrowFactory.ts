...
export interface TitleEscrowFactoryInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "create(uint256)",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getAddress(address,uint256)",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  getEvent(
    nameOrSignatureOrTopic: "TitleEscrowCreated(address,address,uint256)"
  ): EventFragment;
}
...
export interface TitleEscrowFactory extends BaseContract {
  ...
  functions: {
    ...
    getAddress(
      tokenRegistry: PromiseOrValue<string>,
      tokenId: PromiseOrValue<BigNumberish>,
  ...
  filters: {
    "TitleEscrowCreated(address,address,uint256)"(
      titleEscrow?: PromiseOrValue<string> | null,
      tokenRegistry?: PromiseOrValue<string> | null,
