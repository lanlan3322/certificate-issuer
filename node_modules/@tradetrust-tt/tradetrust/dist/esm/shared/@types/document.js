...
export var OpenAttestationHexString = String.withConstraint(function (value) { return ethers.utils.isHexString("0x".concat(value), 32) || "".concat(value, " has not the expected length of 32 bytes"); });
