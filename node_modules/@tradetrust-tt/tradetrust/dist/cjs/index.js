...
exports.v3 = exports.v2 = exports.getData = exports.utils = exports.MerkleTree = exports.checkProof = exports.digestCredential = exports.digestDocument = exports.isSchemaValidationError = exports.validateSchema = void 0;
...
var validateSchema = function (document) {
    return (0, validate_1.validateSchema)(document, (0, ajv_1.getSchema)("".concat((document === null || document === void 0 ? void 0 : document.version) || document_1.SchemaId.v2))).length === 0;
};
