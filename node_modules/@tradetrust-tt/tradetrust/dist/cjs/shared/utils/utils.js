...
var v2 = __importStar(require("../../__generated__/schema.2.0"));
var v3 = __importStar(require("../../__generated__/schema.3.0"));
var w3c_vc_1 = require("@trustvc/w3c-vc");
...
var isDocumentRevokable = function (document) {
    ...
    switch (true) {
        ...
        case (0, guard_1.isWrappedV2Document)(document):
            ...
            var isDidRevokableV2 = (((_b = issuer.identityProof) === null || _b === void 0 ? void 0 : _b.type) === v2.IdentityProofType.Did ||
                ((_c = issuer.identityProof) === null || _c === void 0 ? void 0 : _c.type) === v2.IdentityProofType.DNSDid) &&
                (((_d = issuer.revocation) === null || _d === void 0 ? void 0 : _d.type) === v2.RevocationType.RevocationStore ||
                    ((_e = issuer.revocation) === null || _e === void 0 ? void 0 : _e.type) === v2.RevocationType.OcspResponder);
        ...
        case (0, guard_1.isWrappedV3Document)(document):
            var isDidRevokableV3 = (document.openAttestationMetadata.identityProof.type === v3.IdentityProofType.Did ||
                document.openAttestationMetadata.identityProof.type === v3.IdentityProofType.DNSDid) &&
                ((_f = document.openAttestationMetadata.proof.revocation) === null || _f === void 0 ? void 0 : _f.type) === v3.RevocationType.RevocationStore;
            var isDocumentStoreRevokableV3 = document.openAttestationMetadata.proof.method === v3.Method.DocumentStore &&
...
var isObfuscated = function (document) {
    ...
    if ((0, w3c_vc_1.isSignedDocument)(document)) {
